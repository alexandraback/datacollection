...
namespace CodeJamRound1C2013Console
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            ProblemA_Consonants.Run("A-small-attempt0.in", "A-small-attempt0.out"); // pass 
            //ProblemA_Consonants.Run("A-large.in", "A-large.out"); pass ?

            //ProblemB_Lawnmower.Run("input.txt", "output.txt");
            //ProblemB_Lawnmower.Run("B-small-attempt0.in", "B-small-attempt0.out"); // incorrect for unknown reason
            //ProblemB_Lawnmower.Run("B-small-attempt1.in", "B-small-attempt1.out"); // incorrect for unknown reason
