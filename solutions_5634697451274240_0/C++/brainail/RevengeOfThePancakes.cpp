...
const string INPUT_FILE
        = IDE_PATH + "GoogleCodeJam/2016/QualificationRound/input.txt";
const string OUTPUT_FILE
        = IDE_PATH + "GoogleCodeJam/2016/QualificationRound/output.txt";
...
inline void clearq(queue< int > & q) {
    queue< int > empty;
    swap(q, empty);
}
