...
public class Pancake {
    ...
    public static void main(String args[]) throws FileNotFoundException {
        Scanner scanner = new Scanner(Thread.currentThread().getContextClassLoader().getResourceAsStream("pancake/B-small-attempt0.in"));
        PrintStream printStream = new PrintStream("C:\\Users\\benoi_000\\workspace\\codeJam2016\\process\\pancake\\B-small-attempt0.out" );
