...
public class RevengePancakes {
    public static void main(String[] args) throws FileNotFoundException, IOException{
        ...
        InputStream inputStream = new FileInputStream(new File("./src/B-small-attempt0.in"));
        OutputStream outputStream = new FileOutputStream(new File("./src/B-small-attempt0.out"));
...
class TaskRevengePancakes {
    ...
    public void solve(int taskNumber, InputReaderRevengePancakes in, PrintWriter out) {
        ...
        for(int times = 1; times <= T; ++times){
            String S = in.next();
            System.out.println("Case #" + times + ": " + answer(S));
        }
    }
}
