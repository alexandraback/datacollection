...
public class Pancake {
	...
	public static void main(String[] args) throws IOException {
		List<String> readAllLines = Files.readAllLines(Paths.get("J:\\dev\\eclipse\\imports\\B-small-attempt0.in"));
		BufferedWriter writer = Files.newBufferedWriter(Paths.get("J:\\dev\\eclipse\\imports\\outputPancake.txt"),
