...
public class Pancake {
	...
	public static void main(String[] args) {
		...
		try {
			//A-small-attempt0.in
		    Scanner scanner = new Scanner(new File("/Users/xiangyixie/Documents/eclipse_workspace/2016Codejam/input/B-small-attempt0.in"));
		    FileWriter writer = new FileWriter(new File("/Users/xiangyixie/Documents/eclipse_workspace/2016Codejam/output/B_output_small.txt"), false);
