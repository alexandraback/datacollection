import cra.common.Arithmetic_jsc;
...
public class CJ2015_1C_A {
	...
	static void doProblem(){
		String sDirectory = "R:\\dev\\codejam\\20151C\\A\\";
...
//		String sFileName = "A-large";
		...
		for( int xTestCase = 1; xTestCase <= ctTestCases; xTestCase++ ){
			int[] data = splitInteger( listLines.get( ++xLine ) );
			int r = data[1];
			int c = data[2];
			int w = data[3];
...
//			if( xTestCase % 100 == 0 ) System.out.println( "Case #" + xTestCase + ": " + ctFairAndSquareNumbers );
			sbAnswer.append( "Case #" + xTestCase + ": " + answer + "\n" );
		}
