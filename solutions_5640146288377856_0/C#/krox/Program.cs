...
namespace CJ15Round1C_First
{
	class Program
	{
		static void Main(string[] args)
		{
			...
			using (var s = new StreamWriter(@"c:\users\krox\Downloads\CodeJam\first.small.out", false))
			{
	...
	public static class Read
	{
		...
		{
			return File.ReadAllText(@"c:\users\krox\Downloads\CodeJam\first.small.in");
		}
	}
}
