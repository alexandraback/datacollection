...
namespace Google_Code_Jam___Round_1C
{
    class Problem_A
    {
        public static void Run()
        {
            ...
            using (StreamReader sr = File.OpenText(@"E:\Documents\Google Drive\Coding\Google Code Jam - Round 1C\Google Code Jam - Round 1C\A-small-attempt0.in"))
            {
            ...
            using (StreamWriter sw = File.CreateText(@"E:\Documents\Google Drive\Coding\Google Code Jam - Round 1C\Google Code Jam - Round 1C\A-small-attempt0.out"))
            {
