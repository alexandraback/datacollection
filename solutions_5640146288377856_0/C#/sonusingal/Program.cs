...
namespace GoogleContest
{
    class Program
    {
        ...
        {
            var fr = new FileStream(@"C:\Users\Sonu\Desktop\GC\p-2\r3\\A-small-attempt1.in", FileMode.Open);
            var fr2 = new FileStream(@"C:\Users\Sonu\Desktop\GC\p-2\r3\\A-small-attempt1.out", FileMode.Create);
