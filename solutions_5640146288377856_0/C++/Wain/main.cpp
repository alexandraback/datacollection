...
//    }
    ...
    smallestValue = firsthit+lastStruggle + leftBodyPart;
...
int main(int argc, const char * argv[]) {
    ...
    if ( _testing) {
        vector<int> testInput       = { 1, 4, 2, 1, 7, 7, 2, 5, 1, /*?*/1, 7, 3, 1, 9, 3 };
        vector<int> testOutput      = {       3,       7,      10,            5,       5 };
