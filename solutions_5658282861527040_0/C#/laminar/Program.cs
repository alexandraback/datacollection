...
namespace ConsoleApplicationB
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //using (StreamReader sr = new StreamReader(@"C:\Users\Fred\documents\visual studio 2013\Projects\ConsoleApplicationB\ConsoleApplicationB\B-large-practice.in"))
            {
                ...
                for (int i = 0; i < nTestCases; i++)
                {
                    ...
                    tempTestCase.Calculate();

                    Console.WriteLine(String.Format("Case #{0}: {1}", tempTestCase.id, tempTestCase.result));
                    sw.WriteLine(String.Format("Case #{0}: {1}", tempTestCase.id, tempTestCase.result));
                }
