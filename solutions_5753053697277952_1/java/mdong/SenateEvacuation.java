...
public class SenateEvacuation {
    ...
    public static void main(String[] args) throws IOException {
        in = new BufferedReader(new FileReader("Google CodeJam 2016/Round1C/A-large.in"));
        out = new BufferedWriter(new FileWriter("Google CodeJam 2016/Round1C/A-large.out"));
