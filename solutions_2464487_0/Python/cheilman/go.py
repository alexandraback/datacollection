...
def run(test):
	...
	# Get the paint needed for the root, and one on either side
	# Then filter by how much paint we have
	possibilities = ( (sln-1, paint(sln - 1, r)), (sln, paint(sln, r)), (sln+1, paint(sln + 1, r)) )

	#print possibilities

	possibilities = [ b for b,x in possibilities if x <= t ]
