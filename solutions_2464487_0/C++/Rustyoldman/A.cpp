...
long long int sp = p / (r*r) ;

long long int a = 0 ;

long double low = 0 ;
long double high = 1000000000LL ;

while ( low < high-1 )
   {
   long double mid = (long long ) ((low+high)/2) ;
   //   cout << low << " " << mid * ( 2*r + 2 * mid - 1 ) << " " <<  (p+0.5) << enld ;
  



   if ( mid * ( 2*r + 2 * mid - 1 ) <= (p+0.5) ) 
      low = mid ;
   else
      high = mid ;
   }

//long long int st = n * ( 2 * n + 1 ) ;
//cout << endl ;

cout << "Case #" << case_number << ": " ;
cout << (long long ) (low + 0.5 ) ;
cout << endl ;
}
// ****************************************************************************
