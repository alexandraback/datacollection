...
public class A {
	public static void main(String[] args) throws IOException {
		Scanner scanner = new Scanner(new File("C:\\dev\\codejam\\codejam\\src\\A-small-attempt0.in"));

		PrintWriter out = new PrintWriter("C:\\dev\\codejam\\codejam\\src\\A-small-attempt0.out");
