...
public class Digits {
	...
	public static ArrayList<Integer> checkerino(int num, String nums, int left, HashMap<Character, Integer> chars,
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		for (int c = 1; c <= t; c++) {
			...
			int taken = reduce(chars, result);
			left -= taken;

			result = guess(chars, left, result);
