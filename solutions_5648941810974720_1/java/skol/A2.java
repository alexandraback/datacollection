...
public class A2 {
	...
	static String[] WW = {"ZERO", "EIGHT", "SIX", "TWO", "THREE", "FIVE", "SEVEN", "ONE", "FOUR", "NINE"};
	static int[][] W;
	static int[][] WC;
	static int[] DC = {0, 8, 6, 2, 3, 5, 7, 1, 4, 9};
	...
	Object solve() {
		...
		char[] res = go(cnt, sum, 0).toCharArray();
		Arrays.sort(res);
