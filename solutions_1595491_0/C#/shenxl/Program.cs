...
namespace Dancing_With_the_Googlers
{
    class Program
    {
        ...
        {
            var inputtext = @"E:\Document\JamCode\Dancing_With_the_Googlers\B-small-attempt1.in";
           readLine(inputtext);
        }
        ...
        static void readLine(string path)
        {
            ...
            StreamWriter testfile = File.CreateText(@"E:\Document\JamCode\Dancing_With_the_Googlers\Cout.txt");
