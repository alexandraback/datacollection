...
public class DancingGoogler {
    ...
    public static void main(String[] args) throws Exception {
        BufferedReader br = new BufferedReader(new InputStreamReader(new FileInputStream("E:\\google_code_jam\\B-small-attempt0.in")));
        PrintStream out = new PrintStream(new FileOutputStream("E:\\google_code_jam\\B-small-attempt0.out"));
