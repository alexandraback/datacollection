...
class codeJam1cA {
    ...
    public static void main(String[] args) {
        ...
        try {
            out = new PrintWriter("/Users/vinaysaini/bitbucket/javaprog/src/output.txt");
    ...
    public static class FastScanner {
        ...
        public FastScanner() {
           // br = new BufferedReader(new InputStreamReader(System.in));
            try {
                br = new BufferedReader(new FileReader("/Users/vinaysaini/bitbucket/javaprog/src/A-small-attempt0.in"));
            } catch (FileNotFoundException e) {
                e.printStackTrace();
            }
        }
