...
int main(int argc, const char **argv) {
    ...
    freopen("D:\\Projects\\GitRepo\\CodeRepo\\working\\Round 1C 2016\\A-small-attempt0.in","r",stdin);
    freopen("D:\\Projects\\GitRepo\\CodeRepo\\working\\Round 1C 2016\\A-small-attempt0.out","w",stdout);
    //double st=clock(),en;
    int Test, n, T;
    cin>>Test;
    REP(kase,1,Test) {
