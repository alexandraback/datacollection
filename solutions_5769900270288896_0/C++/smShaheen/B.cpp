...
int call(int r,int n,int mask)
{
   ...
   {
       int adj=0;
       rep(j,1,col) if(checkbit(i,j)&&checkbit(i,j-1)) adj++;
       ret = min( ret, call(r-1,n-countbit(i),i) + countbit((mask&i)) + adj );
   }
