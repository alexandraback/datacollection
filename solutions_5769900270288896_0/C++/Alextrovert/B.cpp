...
#define ToInt(s)   ({ LL i; istringstream SS(s); if (!(SS >> i)) i = 0; i; })
...
int main() {
  Open("B-small-attempt1.in", "");
  Open("", "B-small-attempt1.out");
  cin >> T;
