        ...
        for(int x = 0; x < count; x++) {
            ...
            if(N <= R*C / 2) {
                ...
                while(people < N) {
                    if(!board[0][0]) {
                        board[0][0] = true;
                        unhappiness += countAround(board, 0, 0);
                        people++;
                        continue;
                    }
                    if(!board[R-1][0]) {
                        board[R-1][0] = true;
                        unhappiness += countAround(board, R-1, 0);
                        people++;
                        continue;
                    }
                    if(!board[0][C-1]) {
                        board[0][C-1] = true;
                        unhappiness += countAround(board, 0, C-1);
                        people++;
                        continue;
                    }
                    if(!board[R-1][C-1]) {
                        board[R-1][C-1] = true;
                        unhappiness += countAround(board, R-1, C-1);
                        people++;
                        continue;
                    }
                    boolean found = false;
                    for(int a = 0; a < R; a++) {
                        if(!board[a][0]) {
                            board[a][0] = true;
                            unhappiness += countAround(board, a, 0);
                            found = true;
                            people++;
                            break;
                        }
                        if(!board[a][C-1]) {
                            board[a][C-1] = true;
                            unhappiness += countAround(board, a, C-1);
                            found = true;
                            people++;
                            break;
                        }
                    ...
                    for(int a = 0; a < C; a++) {
                        if(!board[0][a]) {
                            board[0][a] = true;
                            unhappiness += countAround(board, 0, a);
                            found = true;
                            people++;
                            break;
                        }
                        if(!board[R-1][a]) {
                            board[R-1][a] = true;
                            unhappiness += countAround(board, R-1, a);
                            found = true;
                            people++;
                            break;
                        }
