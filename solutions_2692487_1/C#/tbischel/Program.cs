...
namespace ProblemA
{
    class Program
    {
        ...
        {
            const string inputFile = @"E:\Visual Studio Projects\Google Code Jam\cj2013\GoogleCodeJam1B\ProblemA\Input\A-large.in";
            const string outputFile = @"E:\Visual Studio Projects\Google Code Jam\cj2013\GoogleCodeJam1B\ProblemA\Output\large.out";
