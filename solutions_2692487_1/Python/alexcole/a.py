...
fin = open('/Users/alex/Desktop/codejam2/a/A-large.in', 'r')
fout = open('/Users/alex/Desktop/codejam2/a/A-large.out', 'w')
...
for case in range(numcases):
    ...
    othermotes.sort()
    answer = "Case #"+str(case+1)+": "+str(actualnummoves(motesize, othermotes)) + "\n"
    fout.write(answer)
