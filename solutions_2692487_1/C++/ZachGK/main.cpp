...
void eat(long long &size, vector<long long> &motes){
...
int createSolve(long long size, vector<long long> motes, int remove){
...
int solve(long long &size, vector<long long> &motes){
    eat(size, motes);
    minSolve =  motes.size();
