...
public class Osmos {
	...
	public static void main(String[] args) throws Exception {
		LineNumberReader reader = new LineNumberReader(new FileReader(LARGE_DATA_INPUT));
		BufferedWriter writer = new BufferedWriter(new FileWriter(LARGE_DATA_OUTPUT));
		...
		for (int l = 0; l < t; l++) {
			...
			long[] aMote = parseArray(reader.readLine());
			long arminMote = aMote[0];

			long[] motes = parseArray(reader.readLine());
	...
	protected static int smallAdding(long target, long current, long[] motes, int index)
	{
	...
	protected static long[] parseArray(String line)
	{
