...
//		System.out.println(changesNeededToPassLevel(1, otherMotes4));
		BufferedReader in
		   = new BufferedReader(new FileReader("/Users/aniket/Desktop/A-large.in.txt"));
		PrintWriter out
		   = new PrintWriter(new BufferedWriter(new FileWriter("/Users/aniket/Desktop/A-large.out.txt")));
		int caseCounter = 1;
		String line = null;
		double myMote = 0;
		int lineNumber = 0;
