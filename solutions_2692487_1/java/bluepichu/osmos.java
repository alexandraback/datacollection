...
public class osmos{
	public static void main (String [] args) throws IOException{
		BufferedReader br = new BufferedReader(new FileReader("A-large.txt"));
		PrintWriter pw = new PrintWriter(new BufferedWriter(new FileWriter("A-large.out")));
		...
		for(int t = 1; t <= testCases; t++){
			...
			long moteSize = Integer.parseInt(st.nextToken());
