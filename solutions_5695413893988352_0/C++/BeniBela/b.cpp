...
void complete(string& s, char* marks, char insert) {
...
int main(int argc, char *argv[])
{
     ...
     forr (tt, 1, T) {
          ...
          if (delta == -1) {
               ...
               string C2,J2,C3,J3;
               if (C[delta] < J[delta]) {
                    C2 = inc(C,Cc,delta); J2 = J;
                    C3 = C; J3 = dec(J,Jc,delta);
                    complete(C,Cc,'9'); complete(J,Jc,'0');
                    complete(C2,Cc,'0'); complete(J2,Jc,'9');
                    complete(C3,Cc,'0'); complete(J3,Jc,'9');
               } else { //C > J
                    C2 = dec(C,Cc,delta); J2 = J;
                    C3 = C; J3 = inc(J,Jc,delta);
                    complete(C,Cc,'0'); complete(J,Jc,'9');
                    complete(C2,Cc,'9'); complete(J2,Jc,'0');
                    complete(C3,Cc,'9'); complete(J3,Jc,'0');
               }
               Cout = C;
               Jout = J;
