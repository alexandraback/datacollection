...
//            int bb1 = -1, bb2 = -1, bd = -1;
//            for (int i = 0; i < 1000; ++i) {
//                for (int j = 0; j < 1000; ++j) {
//                    String s1 = String.valueOf(i);
//                    String s2 = String.valueOf(j);
//                    if (s1.length() > len || s2.length() > len) continue;
//                    if (match(s1, c1) && match(s2, c2)) {
//                        int d = Math.abs(i - j);
//                        if (bb1 == -1) {
//                            bd = d;
//                            bb1 = i;
...
//            if (bb1 != best1 || bb2 != best2) {
//                throw new AssertionError(bb1 + " "  + bb2 + " " + best1 + " " + best2);
//
//            }
