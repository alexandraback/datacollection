...
public class B {
	...
	public static void solve(Scanner input, PrintWriter output){
		...
		Pair<Integer, Pair<String, String>> ans = dfs(0, s1, s2, "", "", 0);
		output.println(ans.second.first + " " + ans.second.second);
	}
	
	static Pair< Integer, Pair<String,String>> dfs (int state, String s1, String s2, String o1, String o2,int i){
		
		if ( i == s1.length() ){
			int d = Integer.parseInt(o1) - Integer.parseInt(o2);
			if ( d < 0 ) d = -d;
			return new Pair<Integer, Pair<String, String>>(d, new Pair<String, String>(o1,o2));
		}
		...
		if ( s1.charAt(i) == '?' && s2.charAt(i) == '?') {
			...
			Pair<Integer, Pair<String, String>> p = dfs(state, s1, s2, o1 + '0', o2 + '0', i+ 1);
			Pair<Integer, Pair<String, String>> p1 = dfs(1, s1, s2, o1 + '1', o2 + '0', i+ 1);
			Pair<Integer, Pair<String, String>> p2 = dfs(-1, s1, s2, o1 + '0', o2 + '1', i+ 1);
		...
		if ( s1.charAt(i) == '?' && s2.charAt(i) != '?') {
			...
			Pair<Integer, Pair<String, String>> p = dfs(state, s1, s2, o1 + s2.charAt(i), o2 + s2.charAt(i), i+ 1);
			Pair<Integer, Pair<String, String>> p1 = new Pair<Integer, Pair<String, String>>(Integer.MAX_VALUE, new Pair<String, String>(null,null));
			Pair<Integer, Pair<String, String>> p2 = new Pair<Integer, Pair<String, String>>(Integer.MAX_VALUE, new Pair<String, String>(null,null));
		...
		if ( s1.charAt(i) != '?' && s2.charAt(i) == '?') {
			...
			Pair<Integer, Pair<String, String>> p = dfs(state, s1, s2, o1 + s1.charAt(i), o2 + s1.charAt(i), i+ 1);
			Pair<Integer, Pair<String, String>> p1 = new Pair<Integer, Pair<String, String>>(Integer.MAX_VALUE, new Pair<String, String>(null,null));
			Pair<Integer, Pair<String, String>> p2 = new Pair<Integer, Pair<String, String>>(Integer.MAX_VALUE, new Pair<String, String>(null,null));
