...
namespace _2016
{
    class Program
    {
        ...
        {
            string inputFilePath = @"C:\Users\Doron\Desktop\Work\GoogleCodeJam\2016\2016\Problem B\B-small-attempt0.in";
            string outputFilePath = @"C:\Users\Doron\Desktop\Work\GoogleCodeJam\2016\2016\Problem B\B-small-attempt0.out";
            using (FileStream outputFile = File.Open(outputFilePath, FileMode.Create, FileAccess.Write))
            {
                ...
                for (int i = 1; i <= numOfTestCases; i++)
                {
                    ...
                    {
                        input.Add(inputLines[1 + (testCaseNum - 1) * numOfLinesInCase + j]);
                    }
