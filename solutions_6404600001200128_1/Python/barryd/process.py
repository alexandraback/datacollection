...
Notes:
	...
	* I decided a fixed number of passes is fine, and solved the small dataset
	* now I believe the only difference with the large dataset is the size of the numbers involved
