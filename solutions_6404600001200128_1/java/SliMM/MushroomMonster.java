...
public class MushroomMonster implements Solution<int[], String>, InputParser<int[]> {
    ...
    public static void main(String... args) throws IOException {
        ...
        InputStream inputFile = /*System.in;//*/Files.newInputStream(Paths.get("/Users/stefan/Downloads/A-large.in-2.txt"));
        PrintStream outputFile = /*System.out;//*/new PrintStream(Files.newOutputStream(Paths.get("A-large.out.txt")));
