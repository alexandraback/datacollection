...
public class RecycledNumbers {
	...
	public static void main(String[] args) throws IOException {
		BufferedReader br=new BufferedReader(new FileReader(new File("./recyclednumbers/c-large.in")));
		BufferedWriter bw=new BufferedWriter(new FileWriter(new File("./recyclednumbers/large.out")));
