...
public class RecycleNumber {
    ...
    public static void main(String[] args) throws Exception {
        BufferedReader br = new BufferedReader(new InputStreamReader(new FileInputStream("E:\\google_code_jam\\C-large.in")));
        PrintStream out = new PrintStream(new FileOutputStream("E:\\google_code_jam\\C-large.out"));
