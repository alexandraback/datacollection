...
public class Result {
  public static void writeToFile( String text ) {
    try {
      BufferedWriter bw = new BufferedWriter( new FileWriter( new File( "/home/milan/codeJam2015/B/B-large.out" ), true ) );
      bw.write( text );
      bw.newLine();
      bw.close();
    }
  ...
  public static void main( String[] args ) {
    try {
      FileInputStream fstream = new FileInputStream( "/home/milan/codeJam2015/B/B-large.in" );
