...
public class InfiniteHouseOfPancakes {
    public static void main(String[] args) {
        try {
            Scanner scanner = new Scanner(new File("src/InfiniteHouseOfPancakes/B-large.in"));
            PrintWriter writer = new PrintWriter(new File("src/InfiniteHouseOfPancakes/result.txt"));
