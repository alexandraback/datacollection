...
public class TheLastWord {
	...
	public static void main(String[] args) throws IOException {
		...
		try (FileReader fr = new FileReader("data/A-large.in"); BufferedReader br = new BufferedReader(fr); FileWriter fw = new FileWriter("data/A-large.out"); PrintWriter bw = new PrintWriter(fw);) {
