...
namespace CodeJam2016B
{
    class Program
    {
        ...
        {
            string[] input = File.ReadAllLines(@"C:\Users\lincha\Documents\CodeJam1A\a-large.in");
            ...
            File.WriteAllLines(@"C:\Users\lincha\Documents\CodeJam1A\a-large.txt", output.ToArray());
        }
