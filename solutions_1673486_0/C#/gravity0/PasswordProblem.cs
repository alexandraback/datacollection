...
namespace CodeJam
{
    ...
    class PasswordProblem
    {
        ...
        {
            using (StreamReader sr = new StreamReader(@"C:\MyWorks\CodeJam\Data\PasswordProblem\A-small-attempt0.in"))
            using (StreamWriter sw = new StreamWriter(@"C:\MyWorks\CodeJam\Data\PasswordProblem\A-small-attempt0.out"))
            {
