...
namespace ProblemA
{
    class Program
    {
        const string InputPath = @"d:\Work\Current\CodeJam\2012-1A\1\A-small-attempt0.in ";
        const string OutputPath = @"d:\Work\Current\CodeJam\2012-1A\1\A-small-attempt0.out";
