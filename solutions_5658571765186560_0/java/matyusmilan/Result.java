...
public class Result {
  public static void writeToFile( String text ) {
    try {
      BufferedWriter bw = new BufferedWriter( new FileWriter( new File( "/home/milan/codeJam2015/D/D-small-attempt0.out" ), true ) );
      bw.write( text );
      bw.newLine();
      bw.close();
    }
  ...
  public static void main( String[] args ) {
    try {
      FileInputStream fstream = new FileInputStream( "/home/milan/codeJam2015/D/D-small-attempt0.in" );
