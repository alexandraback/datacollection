...
public class Q4 {
	public static void main(String[] args) throws Exception {
		Scanner in = new Scanner(new File("/Users/jonyzfu/Documents/D-small-attempt0.in"));
		PrintWriter out = new PrintWriter(new FileWriter("/Users/jonyzfu/Documents/D-small-attempt0.out"));
		int t = in.nextInt();
		for (int i = 1; i <= t; i++) {
			int x = in.nextInt();
			int r = in.nextInt();
