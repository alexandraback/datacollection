...
static class Res
{
    ...
    static boolean [][][] xrc = new boolean [][][]
            {
                    new boolean [][]{ },
                    new boolean [][]{new boolean[]{ true,true,true,true,true},new boolean[]{ true,true,true,true,true},new boolean[]{ true,true,true,true,true},new boolean[]{ true,true,true,true,true},new boolean[]{ true,true,true,true,true}   },
                    new boolean [][]{new boolean[]{ true,true,true,true,true},new boolean[]{ true,false,true,false,true}, new boolean[]{ true,true,true,true,true}, new boolean[]{ true,false,true,false,true},new boolean[]{ true,true,true,true,true}, },
                    new boolean [][]{new boolean[]{ true,true,true,true,true}, new boolean[]{ false,false,false,false,false} ,new boolean[]{ false,false,false,true,false},new boolean[]{ false,false,true,true,true},new boolean[]{ false,false,false,true,false} },
                    new boolean [][]{new boolean[]{ true,true,true,true,true},new boolean[]{ false,false,false,false,false},new boolean[]{ false,false,false,false,false},new boolean[]{ false,false,false,false,true},new boolean[]{ false,false,false,true,true},   },
