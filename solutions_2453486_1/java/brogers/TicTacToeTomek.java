...
public class TicTacToeTomek
{
	...
	{
		BufferedReader in = new BufferedReader(new FileReader("TicTacToeTomek-large.in"));
		BufferedWriter out = new BufferedWriter(new FileWriter("TicTacToeTomek-large.out", false));
