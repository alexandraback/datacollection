...
public class TicTacToeTomek {
    ...
    public static void main(String[] args) throws Exception {
        InputStream in = new FileInputStream("c:\\work\\java\\GoogleCodeJam2003\\20130403-Qualification\\input\\Tic-Tac-Toe-Tomek\\A-large.in");
        OutputStream out = new FileOutputStream("c:\\work\\java\\GoogleCodeJam2003\\20130403-Qualification\\input\\Tic-Tac-Toe-Tomek\\A-large.out");
        try {
            computeFile(in, out);
        } finally {
            IOUtils.close(in);
