...
public class Main {
	public static void main(String[] args) throws java.io.FileNotFoundException,java.io.IOException{
		...
		java.io.BufferedReader bRead=new java.io.BufferedReader(new java.io.FileReader("F:\\A-large.in"));
		java.io.BufferedWriter bWrite=new java.io.BufferedWriter(new java.io.FileWriter("F:\\A-large.out"));
