...
//            if(
//               (toy[t].id == box[b].id &&
//                 min(toy[t].num , box[b].num) + dp[t-1][b-1].ans > dp[t][b].ans  ) ||
//
//                 (toy[t].id != box[b].id && dp[t-1][b-1].ans > dp[t][b].ans   )
//               )
//               {
//                    ll tmp = 0;
//                    if(toy[t].id == box[b].id)
//                        tmp = min(toy[t].num , box[b].num);
//
//
//                    dp[t][b].ans = dp[t-1][b-1].ans + tmp;
//                    dp[t][b].boxid = box[b].id;
//                    dp[t][b].boxnum = box[b].num - tmp;
//
//                    dp[t][b].toyid = toy[t].id;
