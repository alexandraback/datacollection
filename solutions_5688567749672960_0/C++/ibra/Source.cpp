...
template<> int next<int>(){ int _; scanf_s("%d", &_); return _; }
template<> double next<double>(){ double _; scanf_s("%lf", &_); return _; }
//template<> ll next<ll>(){ ll _; scanf_s("%I64d", &_); return _; }
template<> char next<char>(){ char _[2]; scanf_s("%s", _); return _[0]; }
...
string inpath = "C:/Users/ibismail/Downloads/A-small-attempt1.in";
