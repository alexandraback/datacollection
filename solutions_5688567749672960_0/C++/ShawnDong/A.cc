...
/* .................................................................................................................................. */
char a[20];
const LL inc[50] = {10,19ll, 109ll, 199ll, 1099ll, 1999ll, 10999ll, 19999ll, 109999ll, 199999ll, 1099999ll, 1999999ll, 10999999ll, 19999999ll, 109999999ll, 199999999ll, 1099999999ll, 1999999999ll, 10999999999ll, 19999999999ll, 109999999999ll, 199999999999ll, 1099999999999ll, 1999999999999ll};
LL prefix[20] , suffix[20];
LL solve(LL n){
    if (n < 10){
        return n;
    }
...
//    cerr << "TTT" << out << endl;
    ...
    for (int i = 0 ; i < m ; ++i){
        ...
        suffix[i] += ten * (a[m - 1 - i] - '0');
//        cerr << i << ' ' << suffix[i] << endl;
        ten *= 10;
    }
    reverse(a , a + m);
    LL nn = 0;
    ...
    for (int i = 0 ; i < m ; ++i){
        ...
        prefix[i] += ten * (a[m - 1 - i] - '0');
//        cerr << i << ' ' << prefix[i] << endl;
        ten *= 10;
    }

    checkMin(out , ans + n - t);
    if (a[0] != '0') {
            checkMin(out , ans + nn - t + 1);
            for (int i = 0 ; i < m - 1 ; ++i){
                checkMin(out , ans + 1 + prefix[i] + suffix[m - 2 - i] - 1);
            }
    }
    return out;
}
