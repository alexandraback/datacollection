/*
* @Author: mkg
* @Date:   2016-04-16 07:19:35
* @Last Modified by:   mkg
* @Last Modified time: 2016-04-16 07:25:38
*/
...
int main(int argc, const char **argv) {
	...
	freopen("/Users/mkg/Desktop/Round 1A 2016/A-small-attempt0.in", "r", stdin);
	freopen("/Users/mkg/Desktop/Round 1A 2016/A-small-attempt0.out", "w", stdout);
	//double st=clock(),en;
	int Test, len;
	cin >> Test;
	REP(kase, 1, Test) {
		...
		result = "";
		len = SZ(given);
		result = result + given[0];
		REP(i, 1, (len - 1)) {
			if (given[i] >= result[0]) result.insert(0, 1, given[i]);
			else  result = result + given[i];
		}
