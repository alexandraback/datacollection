...
namespace CodeJam
{
    class Program
    {
        ...
        {
            using (var sr = new StreamReader("C:\\Users\\Brenton\\Desktop\\cj\\A-small-attempt0.in"))
            using (var sw = new StreamWriter("C:\\Users\\Brenton\\Desktop\\cj\\A-small-attempt0.out"))
            {
