...
public class CookieClickerAlpha {
	...
	public void doMain() throws Exception {
		Scanner fr = new Scanner(new FileReader("src/cookieClickerAlpha/B-large.in"));
		PrintWriter fw = new PrintWriter(new FileWriter("src/cookieClickerAlpha/B-large.out"));
