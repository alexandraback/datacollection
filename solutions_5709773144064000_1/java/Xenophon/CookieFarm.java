...
public class CookieFarm extends LineReader<CookieFarmer> {
    ...
    private static final String infileName = "B-large.in";
    ...
    public static class CookieFarmer implements Result {
        ...
        private class Data {
            ...
            public Data(double time, double currentRate) {
                this.time = time;
        ...
        private void simulateCookieFarm() {
            ...
            while (!datas.isEmpty()) {
                Data d = datas.remove(0);
                simulateBuyFarm(d.time, d.currentRate);
            }
        }
        ...
        private void simulateBuyFarm(double timePassed, double currentRate) {
            ...
            datas.add(new Data(buyTime, newRate));
        }
    }
}
