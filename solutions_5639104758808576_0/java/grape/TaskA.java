...
import static util.console.SuperPrinter.*;		// import the cool print functions...
...
public class TaskA {
	...
	static final InputParser ip = new InputParser("input/a/A-small-attempt0.in", og);
//	static final InputParser ip = new InputParser("input/a/A-large-practice.in", og);
