...
int main() {
  ifstream fin("/usr/local/google/home/zhouyuanl/Downloads/A-small-attempt0.in");
  // ifstream fin("/tmp/temp.txt");
  ofstream fout("/usr/local/google/home/zhouyuanl/Downloads/A-small-practice.out");
  int T;
  fin >> T;
  int original[1001];
