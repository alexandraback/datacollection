...
public class Fractiles {
	...
	public static void main(String[] args) throws IOException {
		List<String> readAllLines = Files.readAllLines(Paths.get("J:\\dev\\eclipse\\imports\\D-small-attempt2.in"));
		BufferedWriter writer = Files.newBufferedWriter(Paths.get("J:\\dev\\eclipse\\imports\\outputFractiles3.txt"),
