...
namespace CodeJam
{
    class Program
    {
        ...
        {
            using (var sr = new StreamReader("C:\\Users\\Brenton\\Desktop\\cj\\B-small-attempt1.in"))
            using (var sw = new StreamWriter("C:\\Users\\Brenton\\Desktop\\cj\\B-small-attempt1.out"))
            {
