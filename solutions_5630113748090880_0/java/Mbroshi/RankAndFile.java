...
public class RankAndFile {
    ...
    public static void main(String[] args) throws IOException {
        Scanner sc = new Scanner(new File("/home/mbroshi/Downloads/B-small-attempt0.in"));
        ...
        FileWriter fw = new FileWriter(new File("/home/mbroshi/Downloads/B-small-attempt0.out"));
