/*
* @Author: mkg
* @Date:   2016-04-16 07:41:59
* @Last Modified by:   mkg
* @Last Modified time: 2016-04-16 07:47:55
*/
...
int main(int argc, const char **argv) {
	...
	freopen("/Users/mkg/Desktop/Round 1A 2016/B-small-attempt0.in", "r", stdin);
	freopen("/Users/mkg/Desktop/Round 1A 2016/B-small-attempt0.out", "w", stdout);
	//double st=clock(),en;
	int Test, N, tmp;
	cin >> Test;
	REP(kase, 1, Test) {
