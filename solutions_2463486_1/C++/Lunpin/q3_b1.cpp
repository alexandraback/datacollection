...
int main () {
    ...
    for (int cas=1; cas<=T; cas++) {
        long long A, B;
        int lowBound=0, upBound=47;
        cin >> A >> B;
        while ( I[lowBound] < A ) lowBound++;
        while ( I[upBound] > B ) upBound --;
        cout << "Case #" << cas << ": " << upBound-lowBound+1 << "\n";    
    }
    //system("pause");
}
