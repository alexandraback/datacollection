...
public class FairAndSquare {
    ...
    public static void main(String[] args) throws Exception {
        sc = new Scanner(new FileReader("C-large-1.in"));
        out = new PrintStream(new FileOutputStream("C-large-1.in.out"));
        ...
        // && isPalindrome(BigInteger.valueOf(i * i))) {
        // BigInteger square = BigInteger.valueOf(i * i);
        // int position = Arrays.binarySearch(fsNumbers, square);
        // if (position < 0)
        // out.println(String.format("Not found: %s ^ 2 = %s", i,
        // square));
        // }
        // }
