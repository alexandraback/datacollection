...
namespace Round1
{
    public class Q3
    {
        ...
        Dictionary<Tuple<int, long, int, long>,long> cache;
        ...
        public Q3()
        {
            cache = new Dictionary<Tuple<int, long, int, long>, long>();
        }
        ...
        long result(int b, long mb, int t, long mt)
        {
            ...
            var key = new Tuple<int,long,int,long>(b,mb,t,mt) ;
            ...
            var r = r1 > r2 ? r1 : r2;
            if (!cache.ContainsKey(key)) cache.Add(key,r) ;
