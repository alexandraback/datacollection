...
namespace ProblemA
{
    class Program
    {
        ...
        {
            const string inputFile = @"E:\Visual Studio Projects\Google Code Jam\cj2012\GoogleCodeJam1C\ProblemA\Input\A-small-attempt0.in";
            const string outputFile = @"E:\Visual Studio Projects\Google Code Jam\cj2012\GoogleCodeJam1C\ProblemA\Output\Small-0.txt";
