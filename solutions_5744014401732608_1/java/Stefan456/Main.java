...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        Scanner scanner = new Scanner(new FileInputStream(
            "C:\\Users\\Stefan\\Downloads\\B-large.in"));
        PrintStream output = new PrintStream(
            "C:\\Users\\Stefan\\Downloads\\B-large.out");
        ...
        for (int t = 1; t <= T; ++t) {
            ...
            if (M > maxWays) {
           	...
           	if (B == 2)
           		...
           		output.print("0");
                for (long slide = 1; slide < B - 1; ++slide) {
                	if (M >= maxNodeWays) {
                   		output.print("1");
                   		M -= maxNodeWays;
                	}
            ...
            for (long b = 1; b < B - 1; ++b) {
	            for (long slide = 0; slide < B; ++slide)
	            	if (slide <= b)
	            		output.print("0");
	            	else
	            		output.print("1");
