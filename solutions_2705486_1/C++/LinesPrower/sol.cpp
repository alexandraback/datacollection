...
{                                                                                     \
    ...
    for (int i = 0; i < N; i++) {                                                     \
        ...
        dict[i] = string(buf);                                                        \
        lens[i] = xlen(dict[i]);                                                      \
        mlen = max(mlen, lens[i]);                                                    \
    }                                                                                 \
    fclose(f);                                                                        \
                                                                                      \
}                                                                                     \
                                                                                      \
inline bool check(const char *s, const char *t, int len)                              \
{                                                                                     \
    int k = 0;                                                                        \
    for (int i = 0; i < len; i++) if (s[i] != t[i]) { k++; if (k > 3) return false; } \
    return true;                                                                      \
}                                                                                     \
                                                                                      \
void solvecase()                                                                      \
