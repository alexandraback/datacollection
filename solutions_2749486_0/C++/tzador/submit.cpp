...
int main() {
  char output_buf[1000]; strcpy(output_buf, "codejam/2013/1C/B//solution.cpp"); char *output_pos = strstr(output_buf, "solution.cpp"); strcpy(output_pos, "small.out"); freopen(output_buf, "w", stdout);
  int T;
  scanf("%d\n", &T);
  for (int t = 1; t <= T; t++) {
    int x, y;
