...
int main(int argc, char **argv)
{
	...
	for(int it_t = 1; it_t <= in_t; it_t++)
	{
		...
		else
		{
			...
			switch(x_val)
			{
				case 0:	allow_val = 0; break;
				case 1:	allow_val = 0; break;
				case 2:	allow_val = 0; break;
				case 3:	allow_val = 2; break;
				case 4:	allow_val = 3; break;
				case 5:	allow_val = 4; break;
				case 6:	allow_val = 4; break;
				default: assert(0);
			}
			if(c_val >= allow_val)
			{
