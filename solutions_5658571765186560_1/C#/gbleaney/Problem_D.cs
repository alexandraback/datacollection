...
namespace Google_Code_Jam
{
    public static class Problem_D
    {
        ...
        public static void Run()
        {
            ...
            using (StreamReader sr = File.OpenText(@"E:\My Documents\Google Drive\Coding\Google Code Jam\Google Code Jam\D-large.in"))
            {
            ...
            using (StreamWriter sw = File.CreateText(@"E:\My Documents\Google Drive\Coding\Google Code Jam\Google Code Jam\D-large.out"))
            {
