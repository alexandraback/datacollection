...
public class Question2 
{
	...
	private static void readFile()
	{
		try 
		{
			BufferedReader br = new BufferedReader(new FileReader("C:\\Users\\Marek\\Desktop\\B-small-attempt0.in"));
	...
	private static void printToFile(String[] s)
	{
		try 
		{
			PrintWriter br = new PrintWriter(new FileWriter("C:\\Users\\Marek\\Desktop\\B-small-attempt0.out"));
