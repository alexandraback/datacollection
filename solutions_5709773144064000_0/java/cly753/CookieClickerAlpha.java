...
//		sc = new Scanner(System.in);
		sc = new Scanner(new File("E:\\GitHub\\HHH\\CodeJam\\CookieClickerAlpha\\B-small-attempt0.in"));
		int c = sc.nextInt();
		...
		PrintWriter pw = new PrintWriter(new File("E:\\GitHub\\HHH\\CodeJam\\CookieClickerAlpha\\B-small-attempt0.out"));
		pw.print(sol);
		pw.close();
	}
}
