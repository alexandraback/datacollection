...
namespace Qualif2
{
    class Program
    {
        ...
        {
            var file = new StreamReader(@"C:\Users\Administrator\Documents\CodeJam\second2.txt");
            var outFile = new StreamWriter(@"C:\Users\Administrator\Documents\CodeJam\secondOut2.txt");
