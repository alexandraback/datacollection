...
double soon ;
double cross_over = cost / rate ;
double time = 0 ;
double production = 2 ;
double total = 0 ;


while ( total < goal - 0.00000001 ) 
   {
   double no_buy = (goal) / production + time ;
   double buy = time + cost / production +
          (goal) / ( production + rate ) ; 
// cout << buy << " " << no_buy << endl ;
