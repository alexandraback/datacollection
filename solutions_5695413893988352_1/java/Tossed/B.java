...
public class B {
    ...
    public static String stripZero(String st) {
    ...
    public static long diff(List<String> sts) {
        return Math.abs(Long.parseLong(stripZero(sts.get(0))) - Long.parseLong(stripZero(sts.get(1))));
    }
