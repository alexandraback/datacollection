		    	...
		    	if (a.equals(b)) {
		    		...
		    		while (a.indexOf("?") != -1 || b.indexOf("?") != -1) {
		    			if (a.charAt(po) == '?' && b.charAt(po) == '?') {
		    				as.add(minim(a.replaceFirst("\\?", "1")));
		    				bs.add(maxim(b.replaceFirst("\\?", "0")));
		    				
		    				bs.add(minim(b.replaceFirst("\\?", "1")));
		    				as.add(maxim(a.replaceFirst("\\?", "0")));
		    				...
		    				if (bv < 9) {
		    				as.add(minim(a.replaceFirst("\\?", ""+(bv+1))));
		    				bs.add(maxim(b));
		    				}
		    				if (bv > 0) {
		    				bs.add(minim(b));
		    				as.add(maxim(a.replaceFirst("\\?", ""+(bv-1))));
		    				}
		    				a = a.replaceFirst("\\?", ""+bv);
		    			} else if (b.charAt(po) == '?') {
		    				StringBuilder sb = new StringBuilder();
		    				...
		    				if (av < 9) {
		    				bs.add(minim(b.replaceFirst("\\?", ""+(av+1))));
		    				as.add(maxim(a));
		    				}
		    				if (av > 0) {
		    				as.add(minim(a));
		    				bs.add(maxim(b.replaceFirst("\\?", ""+(av-1))));
		    				}
...
*/
	...
	public static String maxim(String s) {
		//System.out.println(s.replaceAll("\\?", "9"));
		return s.replaceAll("\\?", "9");
	}
	public static String minim(String s) {
