...
class Main {
    ...
    private void solve_small(String S1, String S2) {
	...
	for (int i=0 ; i<S1.length(); i++) {
		...
		for (int n1=0; n1<=9; n1++) {
		    StringBuffer NS11 = new StringBuffer();
		    NS11.append(NS1.toString());
		    NS11.append((char)('0'+n1));
		    long NS11v = Long.parseLong(NS11.toString());
		    if (S2.charAt(i) == '?') {
			for (int n2=0; n2<=9; n2++) {
			    StringBuffer NS21 = new StringBuffer();
			    NS21.append(NS2.toString());
			    NS21.append((char)('0'+n2));
			    long NS21v = Long.parseLong(NS21.toString());
			    long a1 = Math.abs(NS21v - NS11v);
			    if (a1 < minABS) {
				minABS = a1;
				ans1 = n1;
				ans2 = n2;
		...
		if (ans1 != -1) {
		    NS1.append((char)('0'+ans1));
		} else {
		    NS1.append(S1.charAt(i));
		}
		if (ans2 != -1) {
		    NS2.append((char)('0'+ans2));
		} else {
		    NS2.append(S2.charAt(i));
		}
	    } else {
		StringBuffer NS11 = new StringBuffer();
		NS11.append(NS1.toString());
		NS11.append(S1.charAt(i));
		long NS11v = Long.parseLong(NS11.toString());
		long minABS = Long.MAX_VALUE;
		int ans1=-1;
		int ans2=-1;
	...
	output(NS1.toString(), NS2.toString());
    }
