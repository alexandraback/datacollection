...
namespace CodeJamAPC
{
    class Program
    {
        ...
        {
            var input = new StreamReader(@"C:\Users\lincha\Documents\CodeJam1A\c-large.in");
            ...
            File.WriteAllLines(@"C:\Users\lincha\Documents\CodeJam1A\c-large.txt", output.ToArray());
