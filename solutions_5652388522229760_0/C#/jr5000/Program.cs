...
namespace CodeJamResearch
{
    class Program
    {
        ...
        {
            using (var reader = new StreamReader("C:\\Users\\Jon\\Desktop\\CodeJam\\Qualification\\ProblemA\\A-small-attempt1.in"))
            {
                using (var writer = new StreamWriter("C:\\Users\\Jon\\Desktop\\CodeJam\\Qualification\\ProblemA\\A-small.out"))
                {
