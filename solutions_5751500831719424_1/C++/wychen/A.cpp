...
#define FOREACH(i,c) for(typeof(c.begin()) i=(c).begin();(c).end()!=i;++i)
...
#define outv(x) {cerr << #x"={";FOREACH(i,x){cerr << (*i) << " ";}cerr << endl;}
#define outm(x) {cerr << #x"={";FOREACH(i,x){cerr << i->first << ": " << i->second << ", ";}cerr << "}" << endl;}
