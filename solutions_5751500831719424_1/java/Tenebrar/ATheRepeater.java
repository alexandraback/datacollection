...
public class ATheRepeater {
    ...
    public static void main(String[] args) throws Exception {
        try (BufferedReader br = new BufferedReader(new FileReader("/Users/peter/Downloads/A-large.in"));
                PrintStream ps = new PrintStream("/Users/peter/Downloads/A-large.out")) {
