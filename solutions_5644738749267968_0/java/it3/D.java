...
//    private static final String IMPOSSIBLE = "IMPOSSIBLE";
     ...
     * problem
     * 
     * each player has N identical-looking blocks of wood, with masses [0,1] kg  
...
Time taken: 108.482 sec

     */
    static int[] small(int caseNumber, double[] a1, double[] a2) {
        sort(a1);
        sort(a2);
