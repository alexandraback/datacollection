...
const string INPUT_FILE = "D-small-attempt1.in";
const string OUTPUT_FILE = "output_D_small.txt";
...
//until her smaller block is larger than his smallest block AND her largest block is larger than his largest block,
