...
int deceit(int N, array<double, 10> blocksNao, array<double, 10> blocksKen)
{
	int score = 0, i, j;
	for (i = 0; i < N; i++)
	{
...
int war(int N, array<double, 10> blocksNao, array<double, 10> blocksKen)
{
	int score = 0, i, j;
	for (i = N - 1; i >= 0; i--)
	{
...
int main()
{
	...
	int T, i, j, N;
	array<double, 10> blocksNao;
	array<double, 10> blocksKen;
	string s;
