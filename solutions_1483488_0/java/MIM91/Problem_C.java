...
public class Problem_C {
    ...
    public static void main(String[] args) throws IOException {
        ...
        BufferedReader r = new BufferedReader(new FileReader("C-small-attempt0.in"));
        PrintWriter w = new PrintWriter(new BufferedWriter(new FileWriter("C-small-attempt0.out")));
