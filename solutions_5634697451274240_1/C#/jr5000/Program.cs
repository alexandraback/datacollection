...
namespace Codejam2
{
    class Program
    {
        ...
        {
            using (var reader = new StreamReader("C:\\Users\\Jon\\Desktop\\CodeJam\\Qualification\\ProblemB\\B-large.in"))
            {
                using (var writer = new StreamWriter("C:\\Users\\Jon\\Desktop\\CodeJam\\Qualification\\ProblemB\\B-large.out"))
                {
        ...
        static void Solve(int caseNumber, StreamReader reader, StreamWriter file)
        {
            ...
            file.WriteLine("Case #{0}: {1}", caseNumber, total);
            Console.WriteLine("Case #{0}: {1}", caseNumber, total);
        }
