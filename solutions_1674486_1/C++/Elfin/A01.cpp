...
int main()
{
	freopen("C:\\Documents and Settings\\theaa\\My Documents\\Downloads\\A-large.in","r",stdin);
	freopen("C:\\Documents and Settings\\theaa\\My Documents\\Downloads\\A-large.out","w",stdout);
	int T;
	cin>>T;
