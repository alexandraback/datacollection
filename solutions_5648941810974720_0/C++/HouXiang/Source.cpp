...
int main(int argc, char* argv[]) {
	...
	for (int tc = 1; tc <= TC; tc++) {
		...
		digits[0] = characters['Z' - 'A'];
		digits[2] = characters['W' - 'A']; 
		digits[4] = characters['U' - 'A']; 
		digits[5] = characters['F' - 'A'] - digits[4]; 
		digits[6] = characters['X' - 'A']; 
		digits[7] = characters['S' - 'A'] - digits[6]; 
		digits[3] = characters['R' - 'A'] - digits[4] - digits[0]; 
		digits[8] = characters['T' - 'A'] - digits[3] - digits[2]; 
		digits[9] = characters['I' - 'A'] - digits[8] - digits[6] - digits[5]; 
		digits[1] = (n - digits[0] * 4 - digits[2] * 3 - digits[4] * 4 - digits[5] * 4 - digits[6] * 3 - digits[7] * 5 -
			digits[3] * 5 - digits[8] * 5 - digits[9] * 4) / 3; 
