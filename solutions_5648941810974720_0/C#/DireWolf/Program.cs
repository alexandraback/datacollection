...
namespace GoogleCodeJamCSharp
{
    class Program
    {
        ...
        {
            int t;
            using (StreamWriter sw = new StreamWriter(@"C:\Users\Vukasin\Desktop\Petnica\GoogleCodeJam\GoogleCodeJam\A-small.out"))
            {
                using (StreamReader sr = new StreamReader(@"C:\Users\Vukasin\Desktop\Petnica\GoogleCodeJam\GoogleCodeJam\A-small-attempt0.in"))
                {
