...
namespace _2016Round1C
{
    class Program
    {
        ...
        static void C()
        {
            StreamReader sr = new StreamReader("C:\\CodeJam\\2016\\Round1C\\C-small-attempt0.in");
            StreamWriter sw = new StreamWriter("C:\\CodeJam\\2016\\Round1C\\C-small-attempt0.out");
