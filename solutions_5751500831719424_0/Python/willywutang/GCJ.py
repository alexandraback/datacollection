    ...
    def __init__(self, reader, solver, directory, question):
        ...
        try:
            opts, args = getopt(argv[1:],
                                "vs:tlm:x:y:",
                                ["validate", "small", "test", "large", "multi","experiment-small", "experiment-large"])
        ...
        for o,a in opts:
            if o in ("-s", "--small"):
                ...
                self.multi = int(a)
            elif o in ("-x", "--experiment-small"):
                datatype = "small-" + str(int(a))
            elif o in ("-y", "--experiment-large"):
                datatype = "large-" + str(int(a))
