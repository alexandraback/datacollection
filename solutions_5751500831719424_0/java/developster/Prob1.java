...
public class Prob1 {
    ...
    public static void main(String[] args) throws IOException {
        Scanner scanner = new Scanner(new File("/Users/octavian/codejam/A-small-attempt2.in.txt"));
        FileWriter writer = new FileWriter(new File("/Users/octavian/codejam/A-small-attempt2.out.txt"));
