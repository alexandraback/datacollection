...
//    if(data[i].l >= n)
  ...
  for(int i=0; i<data.size(); ++i)
  {
    if(data[i].l >= n)
    {
      long long temp = (Result + (data[i].left + 1) * (data[i].right + 1))%1000000000;
      if(temp > Result)
      {
        Result += ((data[i].left + 1) * (data[i].right + 1))%1000000000;
      }
      else
      {
        Result2 += ((data[i].left + 1) * (data[i].right + 1))/1000000000;
      }
    }
  }
