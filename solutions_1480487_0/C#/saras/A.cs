...
namespace GCJ.GCJ2012.Round1B
{
    internal class A
    {
        ...
        {
            var inputStream = new StreamReader(@"C:\Users\asaraswat\Downloads\A-small-attempt5.in");
            var outputStream = new StreamWriter(@"C:\Users\asaraswat\Downloads\A-small-attempt5.out");
