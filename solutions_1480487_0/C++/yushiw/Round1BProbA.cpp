...
int main() {
    ...
    ofstream outFile;
    ifstream inFile;
    inFile.open("//Users//yushiwang//Documents//Stanford 2011-2012//Spring11-12//CodeJam1b//A-small-attempt1.in");
    outFile.open("//Users//yushiwang//Documents//Stanford 2011-2012//Spring11-12//CodeJam1b//A-small-attempt1.out");
    inFile >> cases;
    inFile.ignore();
    cout << cases;
    int scores[200];
