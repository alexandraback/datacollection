 ...
 */
public class GCJ_2015_R1C_C implements Runnable {
	...
	private void solve() throws IOException {
		...
		for (int test = 0; test < T; test++) {
			...
			int c = scanner.nextInt(); // small 1
			int d = scanner.nextInt(); // small 5
			v = scanner.nextInt(); // small 30
			int[] D = scanner.loadIntArray(d);
			if (inputFromFile){
				System.out.printf("\t1|c=%d  3|v=%d  2|D(%d)=%s\n",c,v,d,Arrays.toString(D));
			}
