...
invd pr(int i){printf("%d",i);}invd pr(bool b){pr((int)b);}invd pr(double d){printf("%.6lf",d);}invd prln(){putchar('\n');}invd prsp(){putchar(' ');}
...
init(){
  freopen("e:/users/johan/downloads/C-small-attempt0.in","r",stdin);
