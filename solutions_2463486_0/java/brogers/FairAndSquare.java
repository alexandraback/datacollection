...
public class FairAndSquare
{
	...
	{
		BufferedReader in = new BufferedReader(new FileReader("FairAndSquare-small-attempt0.in"));
		BufferedWriter out = new BufferedWriter(new FileWriter("FairAndSquare-small-attempt0.out", false));
