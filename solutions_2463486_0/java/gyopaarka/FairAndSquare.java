...
public class FairAndSquare {
    ...
    public static void main(String[] args) throws Exception {
        InputStream in = new FileInputStream("c:\\work\\java\\GoogleCodeJam2003\\20130403-Qualification\\input\\FairAndSquare\\C-small-attempt0.in");
        OutputStream out = new FileOutputStream("c:\\work\\java\\GoogleCodeJam2003\\20130403-Qualification\\input\\FairAndSquare\\C-small-attempt0.out");
        try {
            computeFile(in, out);
        } finally {
            IOUtils.close(in);
