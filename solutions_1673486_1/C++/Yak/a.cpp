...
long double calc(UI A, UI B, vector<long double> &p)
{
	double pp = accumulate(p.begin(), p.begin() + A, static_cast<long double>(1.0), [](double d1, double d2) { return d1 * d2; });
