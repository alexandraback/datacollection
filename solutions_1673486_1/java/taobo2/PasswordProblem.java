...
public class PasswordProblem {
    ...
    public static void main(String[] args) throws Exception {
        Scanner scanner = new Scanner(new BufferedInputStream(new FileInputStream("/Users/taobo2/Documents/A-large.in")));
        Writer writer = new BufferedWriter(new FileWriter("A-large-attempt0-1ans.txt"));
