...
//        io = new Kattio(new FileInputStream("round1b/C-sample.in"), System.out);
        io = new Kattio(new FileInputStream("round1b/C-small-attempt0.in"), new FileOutputStream("round1b/C-small-0.out"));
//        io = new Kattio(new FileInputStream("round1b/C-large-0.in"), new FileOutputStream("round1b/C-large-0.out"));
