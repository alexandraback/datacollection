...
// 		return p1.first - p1.second > p2.first - p2.second || p1.first - p1.second == p2.first - p2.second && p1.first > p2.first;
// 	};
// };
// int solve2(ll n){
// 	dd.clear();
