...
namespace Dijkstra
{
    class Program
    {
                ...
                using (StreamReader sr = new StreamReader(path))
                {
                    while (sr.Peek() > 0)
                    {
                        ...
                        else
                        {
                            ...
                            int numberRepeated = int.Parse(splitted[1]);
        ...
        static string getNumber(int numberCharacter, int numberRepeated, string dataToAnalyze)
        {
            int numberPeriod = numberRepeated;
            char tempoRes = '1';
            int sign = 1;
            ...
            int limit = numberRepeated % numberPeriod;
            bool first = false;
            bool second = false;
