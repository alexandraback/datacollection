...
if __name__ == '__main__':
    ...
    for t in xrange(1, T+1):
        ...
        #X = X % 16 # four copies of anything multiplied together = 1
        ...
        for suffix_count, suffix_value in enumerate(fp):
            ...
            for i, ch in enumerate(reversed(string)):
                ...
                #if prod != collapse(suf + string * suffix_count):
                #    raise Exception('wtf')
                if prod == KAY:
        ...
        """
        print 'full product:', nice(full_product)
        print 'x', X
        print 'FP:'
        for i in xrange(4):
        ...
        print 'i magic:'
        for i in xrange(4):
            print str(i), str(i_magic[i])
        print 'k magic:'
        for i in xrange(4):
            print str(i), str(k_magic[i])
        """
