...
const int minTimesIsNeeded = 40; // 4 equals substring gives a reduce equals to 1. 4 * 3 = 12. We'll take 50 - it's enough.
...
bool solve(const string &s, int times) {
    int smartTimes = min(times, minTimesIsNeeded + times % 4);
