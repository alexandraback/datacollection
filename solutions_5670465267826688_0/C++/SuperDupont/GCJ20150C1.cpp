// GCJ20150C1.cpp : définit le point d'entrée pour l'application console.
//
...
public:
	...
	void PerformLoop()
	{
		...
		// Spécifique
		int Left[10001], Right[10001], Ch[10000], Ch0[10000], ValCh, ChPuis[4];
		...
		*FicIn >> in;
		...
		// Cas particulier : on ne se casse pas, on fabrique la chaîne
		i = 0;
		for (j = 0; j < X; j++)
			for (k = 0; k < L; k++)
				Ch[i++] = Ch0[k];
	...
	void Perform()
	{
		...
		FicIn = new fstream("C-small-attempt0.in", ifstream::in);
