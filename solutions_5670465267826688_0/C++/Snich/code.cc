    ...
    for (int tc = 1; tc <= t; tc++) {
        ...
        if (products.back() != 1) {
          if (products.back() == -1 && num_repeats % 2 == 1) {
            string t = "";
            for (int i = 1; i <= min(num_repeats, 12); i += 2) {
              t += s;
            ...
            string t = s;
            for (int i = 2; i <= min(num_repeats, 12); ++i) {
              t += s;
        ...
        //string t = s;
        //for (int i = 2; i <= num_repeats; ++i) {
          //t += s;
        //}
        //cerr << endl;
        //if (is_good(get_products(t)) != ok) {
          //cerr << endl;
          //cerr << num_repeats << ' ' << s << endl;
          //cerr << endl;
          //cerr << products.back() << endl;
          //cerr << "bad\n";
          //return 1;
        //}
        cout << (ok ? "YES" : "NO");
