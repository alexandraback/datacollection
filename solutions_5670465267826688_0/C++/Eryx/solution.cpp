...
char mul(char a, char b) {
  if(a == NG) return neg(b);
  if(b == NG) return neg(a);
  if(a == '1') return b;
  if(b == '1') return a;
  if(a >= 'I' && a <= 'K') return neg(mul(a^32, b));
  if(b >= 'I' && b <= 'K') return neg(mul(a, b^32));
  if(a == b) return NG;
  if(a == 'i' && b == 'j') return 'k';
  if(a == 'j' && b == 'k') return 'i';
  if(a == 'k' && b == 'i') return 'j';
