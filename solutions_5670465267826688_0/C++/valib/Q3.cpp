...
bool ijk_feasible(int L, int X, string& str, map<char, int>& lut){
...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	freopen("D://Practice//C-small-attempt0.in", "r", stdin);
    freopen("D://Practice//C-small-attempt0.out", "w", stdout);
	int cases;
	cin>>cases;
