...
//All the YES are correct. There must be some false NO's.
int main()
{
	int testCases;
	std::cin >> testCases;
	for (int t = 1; t <= testCases; ++t) {
		...
		//}
		//std::string test = "1";
		//for (std::size_t i = jLocation + 1; i != holyFuck.size(); ++i) {
		//	test = multiply(test, std::string(1, holyFuck[i]));
		//}
		//std::cout << "Test should be k: " << test << std::endl;
