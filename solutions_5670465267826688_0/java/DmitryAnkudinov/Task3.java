...
public class Task3 {
	public static void main(String[] args) throws FileNotFoundException {
		File file = new File("./data/C-small-attempt0.in");
		PrintStream out = new PrintStream(new FileOutputStream("./data/C-small-attempt0.out"));
		System.setOut(out);
