...
public class Dijkstra {
    ...
    public static int GetComplexNum(int count, int L, String input) {
        count = count % L;
    ...
    public static void main(String args[]) throws IOException {
        ...
        BufferedReader reader = new BufferedReader(new FileReader("src/google/codejam2015/round1a/C-small-attempt0" +
                ".in"));
        BufferedWriter writer = new BufferedWriter(new FileWriter("src/google/codejam2015/round1a/C-small-attempt0" +
                ".out"));
        ...
        for (int _t = 0; _t < T; _t++) {
            ...
            int L = Integer.parseInt(temp2[0]), X = Integer.parseInt(temp2[1]);
            ...
            int result2 = ONE;
            for(int i = 0; i < X; i++) {
                result2 = multiply(result2, result_single);
            }
            if(result2 == result1) {
