...
class Main{
        ...
        public static void solve(int test) throws IOException
        {
            ...
            char pref[]=new char[l*x+1];
            pref[0]=arr[0];
            if(pref[0]=='i')fi=1;
            for(int i=1;i<l*x;i++)
            {
                pref[i]=map(pref[i-1],arr[i]);
                if(pref[i]=='i')fi=1;
                else if(fi==1 && pref[i]=='k')fj=1;
                
            }
            if(fi==1 && fj==1 && pref[l*x-1]=='n')
            out.println("Case #"+test+": YES");
            else out.println("Case #"+test+": NO");
        }
        ...
        public static char map(char f,char s)
        {
          if(f=='i' && s=='i')return 'n';
          else if(f=='i' && s=='j')return 'k';
          else if(f=='i' && s=='k')return 'J';
          else if(f=='n' && s=='i')return 'I';
          else if(f=='p' && s=='i')return 'i';
          else if(f=='j' && s=='i')return 'K';
          else if(f=='j' && s=='j')return 'n';
          else if(f=='j' && s=='k')return 'i';
          else if(f=='n' && s=='j')return 'J';
          else if(f=='p' && s=='j')return 'j';
          else if(f=='k' && s=='i')return 'j';
          else if(f=='k' && s=='j')return 'I';
          else if(f=='k' && s=='k')return 'n';
          else if(f=='n' && s=='k')return 'K';
          else if(f=='p' && s=='k')return 'k';
          else if(f=='I' && s=='i')return 'p';
          else if(f=='I' && s=='j')return 'K';
          else if(f=='I' && s=='k')return 'j';
          else if(f=='J' && s=='i')return 'k';
          else if(f=='J' && s=='j')return 'p';
          else if(f=='J' && s=='k')return 'I';
          else if(f=='K' && s=='i')return 'J';
          else if(f=='K' && s=='j')return 'i';
          else if(f=='K' && s=='k')return 'p';
