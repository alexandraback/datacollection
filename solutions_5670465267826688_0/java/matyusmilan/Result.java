...
public class Result {
  public static void writeToFile( String text ) {
    try {
      BufferedWriter bw = new BufferedWriter( new FileWriter( new File( "/home/milan/codeJam2015/C/C-small-attempt1.out" ), true ) );
  ...
  public static void main( String[] args ) throws Exception {
    FileInputStream fstream = new FileInputStream( "/home/milan/codeJam2015/C/C-small-attempt1.in" );
    ...
    for( int i = 1; i <= T; ++i ) {
      ...
      int origRepeat = Integer.parseInt( line[1] );
      String input = br.readLine();
      int repeat = origRepeat % 4;
      if( repeat == 0 ) {
