...
public class Main{
	...
	private static void initTable() {
		...
		table['i']['1']='i';		table['i']['i']='4';		table['i']['j']='k';		table['i']['k']='m';
		table['j']['1']='j';		table['j']['i']='n';		table['j']['j']='4';		table['j']['k']='i';
		table['k']['1']='k';		table['k']['i']='j';		table['k']['j']='l';		table['k']['k']='4';
	}
	...
	private static void workForBig() {
