...
public class Solution {
	...
	public static boolean judge(String s, int repeat) {
		int origin = repeat * s.length();
		...
		if (signi && signj && counti == 2 && countj == 4 && i < (j + origin - length)) return true;
		else return false;
	}
	public static void main(String[] args) {
		...
		for (int i = 0; i < num; ++i) {
			...
			String res = judge(s, repeat) ? "YES" : "NO";
