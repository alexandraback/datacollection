...
fin = open('/Users/alex/Desktop/codejam/b/B-small-attempt0.in', 'r')
fout = open('/Users/alex/Desktop/codejam/b/B-small-attempt0.out', 'w')
    ...
    for  x in range(w):
        for y in range(h):
            if data[x][y]< min(horzcuts[x], vertcuts[y]):
                return "Case #"+str(i)+": NO\n"
    return "Case #"+str(i)+": YES\n"
