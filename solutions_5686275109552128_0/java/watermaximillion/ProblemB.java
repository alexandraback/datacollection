...
public class ProblemB {
	...
	public static void main(String[] args) throws IOException {
		...
		for(int caseNum = 1; caseNum <= numCases; caseNum++){
			...
			ArrayList<Integer> pancakes2 = new ArrayList<Integer>();
			while(s.hasNext()){
			...
			Collections.sort(pancakes2);
			int answer2 = brute2(pancakes2);
			//int answer1 = brute(pancakes, answer2, 0);

//			if(answer1 != answer2) System.out.println(line + ": " + answer1 + " " + answer2);
	//		if(answer1 == answer2) System.out.println(answer1);
			write("" + answer2, caseNum);
		}
		writer.close();
		br.close();
