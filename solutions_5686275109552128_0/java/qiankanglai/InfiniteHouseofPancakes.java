...
public class InfiniteHouseofPancakes {
    public static void main(String args[]) throws IOException {
        ...
        BufferedReader reader = new BufferedReader(new FileReader("src/google/codejam2015/round1a/B-small-attempt4" +
                ".in"));
        BufferedWriter writer = new BufferedWriter(new FileWriter("src/google/codejam2015/round1a/B-small-attempt4" +
                ".out"));
