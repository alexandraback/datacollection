...
# def brute_force(pancakes):
#     if len(pancakes) == 1:
#         return one_diner(pancakes[0], pancakes[0])
#     best, specials = one_diner(pancakes[0], pancakes[0])
#     for s in xrange(pancakes[0]):
#         sub_best, sub_specials = brute_force(pancakes[1:])
#         new_specials = sub_specials + s
#         new_best = max(sub_best - sub_specials, int(math.ceil(pancakes[0]/(s+1.0)))) + new_specials
#         if new_best < best:
#             best = new_best
#             specials = new_specials
#     return best, specials
