...
public class PartElf {
	...
	public PartElf(){
		inFile = new File("A-small-attempt2.in");
		outFile = new File("A-small-attempt2.out");
	}
	...
	private void solve(){		
		try {
			...
			for (int c = 1; c <= cases; c++) {
				...
				long P = Integer.parseInt(fracSplit.nextToken()); 
				long Q = Integer.parseInt(fracSplit.nextToken()); 
