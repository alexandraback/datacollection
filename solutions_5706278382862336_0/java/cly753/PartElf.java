...
public class PartElf {
    ...
    public static void main(String[] args) throws Exception {
      ...
      sc = new Scanner(new File("E:\\GitHub\\HHH\\CodeJam\\PartElf\\A-small-attempt4.in"));
      int c = sc.nextInt();
      String sol = "";
      ...
      PrintWriter pw = new PrintWriter(new File("E:\\GitHub\\HHH\\CodeJam\\PartElf\\A-small-attempt4.out"));
      pw.print(sol);
      pw.close();
    }
    ...
    public static String solve() {
        ...
        int p = Integer.parseInt(tempS.split("/")[0]);
        int q = Integer.parseInt(tempS.split("/")[1]);
