...
//		BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
		BufferedReader br = Files.newBufferedReader(Paths.get("input.iin.in", args), Charset.defaultCharset());
		...
		for (int cs = 0; cs < CASES; cs++)
		{
			...
			int P = Integer.parseInt(line.substring(0, space));
			int Q = Integer.parseInt(line.substring(space + 1));
