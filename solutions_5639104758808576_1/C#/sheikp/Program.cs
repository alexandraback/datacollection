...
namespace CodeJam1
{
    class Program
    {
        ...
        {
            string[] lines = System.IO.File.ReadAllLines(@"D:\Input\A-large.in");
            ...
            foreach (string line in lines)
            {
                ...
                if(i > 0)
                { 
                string strshy = line.Substring(line.IndexOf(" ") + 1);
            ...
            System.IO.File.WriteAllLines(@"D:\Input\A-large.out", outputlines);
