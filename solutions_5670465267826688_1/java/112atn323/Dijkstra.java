...
public class Dijkstra {
	...
	public String solve(String str, long n) {
		...
		while (offset%str.length()!=0) {
			...
			if (offset<0)
				return "NO";
			if (used[(int)(offset%str.length())])
				return "NO";
			else
				used[(int)(offset%str.length())] = true;
		}
		if (offset==str.length()*n)
			return "YES";
		...
		do {
			...
			if (offset2<0)
				return "NO";
			if (used[(int)(offset2%str.length())])
				return "NO";
			else
				used[(int)(offset2%str.length())] = true;
	...
	public static void main(String args[]) throws IOException {
		String inputPath = "file/world2015/qualification_round/C-large.in";
