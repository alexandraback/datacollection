    ...
    class Dijkstra : GCJBase
    {
        ...
        private string dijkPoss(string str, long rep)
        {
            ...
            do
            {
                ...
                if (sw.ElapsedMilliseconds > 2000) return "NO";
            } while (true);
            ...
            int[] stateMatrix = new int[50];
            int[] signMatrix = new int[50];
            stateMatrix[0] = state;
            signMatrix[0] = statesign;
            for (int i = 1; i < 50; i++)
            {
                mult(stateMatrix[i - 1], stateMatrix[i - 1], signMatrix[i - 1], signMatrix[i - 1], out stateMatrix[i], out signMatrix[i]);
            }
            ...
            for (int i = 0; i < 50; i++)
            {
                if ((l1 << i & rep) > 0)
                {
                    ...
                    mult(state, stateMatrix[i], statesign, signMatrix[i], out state2, out statesign2);
                    state = state2;
