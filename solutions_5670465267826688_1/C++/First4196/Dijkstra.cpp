...
#define     F0(a,b)         for(LL a=0;a<=b;a++)
#define     R0(a,b)         for(LL a=b;a>=0;a--)
#define     F1(a,b)         for(LL a=1;a<=b;a++)
#define     R1(a,b)         for(LL a=b;a>=1;a--)
#define     FV(a,b)         for(LL a=0;a<v[b].size();a++)
#define     RV(a,b)         for(LL a=0;a<rv[b].size();a++)
