...
ifstream fin ("C:\\CodeJam\\2015\\1A\\A\\A-small-attempt0.in");
ofstream fout ("C:\\CodeJam\\2015\\1A\\A\\A-small-attempt0.out");
...
void Solve()
{
	...
	fout << "Case #" << testCase << ": "<<sum<<" "<<sum2<<endl;
