...
namespace RoundA_A
{
    class Program
    {
        ...
        {
            using (StreamReader stream = new StreamReader("C:/Users/Montana/Desktop/A-small-attempt1.in"))
            using (StreamWriter output = new StreamWriter("C:/Users/Montana/Desktop/A-small-attempt1.out"))
            {
