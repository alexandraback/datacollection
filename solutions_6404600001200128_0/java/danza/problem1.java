...
public class problem1 {
	...
	public static void main(String[] args) throws IOException {
		...
		try (Writer writer = new BufferedWriter(new OutputStreamWriter(
	              new FileOutputStream("/home/danza/Downloads/output1.txt"), "utf-8"))) {
	  // writer.write("something");
		
		int j=1;
		BufferedReader br = new BufferedReader(new FileReader("/home/danza/Downloads/A-small-attempt0 (1).in"));
	    try {
