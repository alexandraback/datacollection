...
* @Last Modified time: 2016-04-16 07:48:58
*/
...
int main(int argc, const char **argv) {
	...
	freopen("/Users/mkg/Desktop/Round 1A 2016/B-large.in", "r", stdin);
	freopen("/Users/mkg/Desktop/Round 1A 2016/B-large.out", "w", stdout);
	//double st=clock(),en;
	int Test, N, tmp;
	cin >> Test;
	REP(kase, 1, Test) {
