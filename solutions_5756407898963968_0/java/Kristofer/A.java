...
public class A {
    ...
    public class Solver implements Callable<String> {
        ...
        private final Set<Integer> candidates2;
        ...
        public Solver(int caseNumber) {
            ...
            asd(candidates);
            candidates2 = new TreeSet<Integer>();
            asd(candidates2);
        }

        private void asd(Set<Integer> candidates2) {
            int choice;
            choice = getInt() - 1;
            for (int i = 0; i < 4; i++) {
                for (int j = 0; j < 4; j++) {
        ...
        public String call() throws Exception {
            ...
            TreeSet<Integer> solution = new TreeSet<Integer>(candidates);
            solution.retainAll(candidates2);
            if (solution.isEmpty()) {
