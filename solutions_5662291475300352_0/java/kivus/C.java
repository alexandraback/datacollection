    ...
    private static void doCase(int caseNumber, Scanner scanner, PrintWriter wr) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            for (int j = 0; j < list.size(); j++) {
                ...
                Hiker hh = list.get(j);
                double time = (double)follow.m * (double)(360 - follow.d ) / 360;
                ...
                if (hh.m == follow.m) {
                    ...
                    if (follow.d > hh.d) {
                        ...
                        double time2 = (double)hh.m * (double)(360 - hh.d) / 360;
                        if (time2 > time) {
                            encounters++;
                        }
                    }
                    ...
                    double t0 = (double)hh.m * (double)(360 - hh.d) / 360;
                    double timeLeft = time - t0;
                    if (timeLeft > 0) {
                        double fullCircles = timeLeft / hh.m;
                        int fullC = (int)Math.floor(fullCircles);
                        if (fullC > 0) {
                            encounters += fullC;
                        }
                    }
