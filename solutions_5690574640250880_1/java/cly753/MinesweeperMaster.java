...
//		sc = new Scanner(System.in);
		sc = new Scanner(new File("E:\\GitHub\\HHH\\CodeJam\\MinesweeperMaster\\C-large.in"));
		int c = sc.nextInt();
		...
		PrintWriter pw = new PrintWriter(new File("E:\\GitHub\\HHH\\CodeJam\\MinesweeperMaster\\C-large.out"));
		pw.print(sol);
		pw.close();
	}
}
