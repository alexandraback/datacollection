...
public class InputOutput {
	...
	public void writeFile (String outputFile, boolean noSpace, boolean backSpace) {
		...
		boolean printBackSpace = backSpace;
	...
	public static void main(String[] args) {
		...
		String directory = "./data/MinesweeperMaster/";
		String inputFile = directory + "C-large.in";
		String outputFile = directory + "C-large.out";
		
		boolean noSpace = true;
		boolean backSpace = true;
		String className = "codes.MinesweeperMaster";
		
		String methodName = "oneClickResult";
		...
		instance.writeFile(outputFile, noSpace, backSpace);
	}
}
