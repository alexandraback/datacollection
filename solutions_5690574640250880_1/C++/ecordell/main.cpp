...
{
    std::ifstream infile("/Users/evan/Git/GoogleCodeJam/Qualification/Problem C/QualProblemC/QualProblemC/C-large.in");
    std::ofstream outfile;
    outfile.open("/Users/evan/Git/GoogleCodeJam/Qualification/Problem C/QualProblemC/QualProblemC/large.out");
