...
//          System.out.println(i+" "+primes.size());
    ...
    for (int tc = 1; tc <= TC; tc++) {
      ...
      int f = (new BigInteger("1000000000000001",2)).intValue();
      int t = (new BigInteger("1111111111111111",2)).intValue();
      
      ArrayList<String> goods = new ArrayList<String>();
      int countFound = 0;
      
      for (int i = f; i <= t && countFound<J; i=i+1)
      {
        boolean good=true;
        
        String binar = Integer.toString(i, 2);
        if(!binar.endsWith("1"))
          continue;
