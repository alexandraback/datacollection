...
namespace CoinJam
{
    class Program
    {
        ...
        {
            System.IO.StreamReader input = new System.IO.StreamReader(@"D:\codejam\CoinJam\C-small-attempt0.in");
            System.IO.StreamWriter output = new System.IO.StreamWriter(@"D:\codejam\CoinJam\C-small-attempt0.out");
            ...
            while (j>0)
            {
                ...
                if (valid)
                {
                    string cur = string.Join("", number) + divisor;
