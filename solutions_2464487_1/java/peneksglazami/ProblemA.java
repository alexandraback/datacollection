...
public class ProblemA {
    ...
    private void run() throws Exception {
        Scanner scanner = new Scanner(new BufferedReader(new FileReader("A-large.in")));
        ...
        for (int test = 1; test <= testCount; test++) {
            ...
            BigDecimal res = BigDecimal.valueOf(-b).add(sqrt(d, 100)).divide(BigDecimal.valueOf(4));
