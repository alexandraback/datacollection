...
public class A {	
    ...
    public boolean isOK(double n, double start, double t){
    	double tside = t/n - (start-4);
    	double requireside = 2*(1+n);
    	System.out.println( tside + ", " + requireside );
    	return tside >= requireside;
    	
//    	long require = 2 * (1 + n) * n;
//    	
////    	System.out.println( require );
//    	System.out.println( t - n*(start-4) + ", " + require);
//    	if( (t - n*(start-4))/2 >= require ){
//    		return true;
//    	}
//    	return false;
    }
