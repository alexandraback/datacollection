			...
			for(int q = 0; q < J; q++){
				...
				while(true){
					...
					for(int base = 2; base <= 10; base++){
						final BigInteger value_based = new BigInteger(value_str, base);
						
						boolean ok = false;
						for(int i = 2; i <= 10000; i++){
							if(value_based.mod(BigInteger.valueOf(i)) == BigInteger.ZERO && value_based.divide(BigInteger.valueOf(i)) != BigInteger.ONE){
