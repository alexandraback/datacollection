...
public class QR16_C {
	...
	public static void main(String[] args) throws IOException {
		...
		FileReader fr = new FileReader(new File("/home/rohit/Desktop/codejam/c/large.in"));
		BufferedReader br = new BufferedReader(fr);
		
		FileWriter fw = new FileWriter(new File("/home/rohit/Desktop/codejam/c/large.out"));
	...
	private static BigInteger isPrime(BigInteger ss) {
		...
		BigInteger lim  = BigInteger.valueOf(10000);
