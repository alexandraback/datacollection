...
//        long long sum = 0;
        ...
        for (int i = 0; i<a.length(); i++) {
            BigNum temp((a[i]-'0') *pow(index, a.length()-i-1));
//            sum = sum + (a[i]-'0') * pow(index, a.length()-i-1);
            sum = sum + temp;
        }
//        long long temp = is_prime(sum);
        long long test = is_prime(sum);
        if (test==1) {
            return 0;
        }
...
int main(){
    ...
    if(freopen("/Users/Victor/Desktop/C-large.in", "r", stdin) == NULL)
