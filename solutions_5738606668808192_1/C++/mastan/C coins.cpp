        ...
        if (ok)
        {
            ...
            for (int bs=2; bs<=10; bs++)
            {
                ...
                for (int i=0; i<cntpr; i++)
                    ...
                    {
                        if (val==primes[i])
                            printf("WARING BAD!WARING BAD!WARING BAD!WARING BAD!WARING BAD!WARING BAD!WARING BAD!WARING BAD!WARING BAD!WARING BAD!WARING BAD!\n");
                        printf("%lld ",primes[i]);
                        break;
                    }
            }
