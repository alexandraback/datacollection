...
int main() 
{
	...
	int temp[constantN-3];
	for (int i=0; i<constantN-3; i++)
		temp[i]=0;
	...
	{
		generate_temp(temp);
		int number1[constantN];
		for (int i=0; i<constantN; i++)
			number1[i]=0;
		number1[1]=1;
		number1[constantN-1]=1;
		for (int i=0; i<constantN-3; i++)
			number1[i+2]=temp[i];
		int number2[constantN];
		for (int i=0; i<constantN; i++)
			number2[i]=0;
		for (int i=1; i<constantN; i++)
