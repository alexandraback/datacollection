...
namespace Patrickdev.Gcj.Qualification2016.D_Fractiles
{
    ...
    {
        public string GetInputFile() { return @"D:\Cloud\programming\c#\gcj\gcj\Qualification2016\D_Fractiles\D-large.in"; }
        ...
        public string DoIteration(Scanner input, Output output)
        {
            ...
            else
            {
                ...
                {
                    BigInteger posAtComplexity1 = i + 2;

                    if (posAtComplexity1 > originalSequenceLength)
                        posAtComplexity1 = originalSequenceLength;
                    
                    BigInteger toAdd = i * BigInteger.Pow(originalSequenceLength, complexity - 1);

                    toCheck.Add(toAdd + posAtComplexity1);
                }
            }
