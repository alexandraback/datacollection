...
//            log("addResult ", testcase, result);
    ...
    private static String inputFile = "D-large.in";
//    private static String inputFile = "D-large.in";
...
//            log("handle testcase", testcase, "dinners", dinners);
            ...
            else
            {
                ...
                {
                    for (int i = 0, end = listPos.size() - 1; i < end; i++)
                        r.append(listPos.get(i)).append(' ');
                    r.append(listPos.get(listPos.size() - 1)).append(' ');
                }
            }

            //log("finish testcase", testcase, "dinners", dinners);
            addResult(r.toString());
            log(sb);
        }
