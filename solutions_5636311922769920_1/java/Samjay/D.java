...
public class D {
	...
	private static final String fileName = fileLoc+D.class.getSimpleName().toLowerCase()+islarge;
	...
	private void solve() {
		int K = in.readInt(), // number of initial tiles
			C = in.readInt(), // complexity
			S = in.readInt(); // number of tiles to clean
		if(S*C < K){
