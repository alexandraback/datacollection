...
namespace CodeJam
{
    ...
    class KingdomRush
    {
        ...
        {
            using (StreamReader sr = new StreamReader(@"C:\MyWorks\CodeJam\Data\KingdomRush\B-small-attempt0.in"))
            using (StreamWriter sw = new StreamWriter(@"C:\MyWorks\CodeJam\Data\KingdomRush\B-small-attempt0.out"))
            {
