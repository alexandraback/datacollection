...
namespace Qualif4
{
    class Program
    {
        ...
        {
            var file = new StreamReader(@"C:\Users\Administrator\Documents\CodeJam\forth3.txt");
            var outFile = new StreamWriter(@"C:\Users\Administrator\Documents\CodeJam\forthOut3.txt");
