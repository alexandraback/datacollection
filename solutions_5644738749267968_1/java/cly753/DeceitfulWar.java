...
//		sc = new Scanner(System.in);
		sc = new Scanner(new File("E:\\GitHub\\HHH\\CodeJam\\DeceitfulWar\\D-large.in"));
		int c = sc.nextInt();
		String sol = "";
		...
		PrintWriter pw = new PrintWriter(new File("E:\\GitHub\\HHH\\CodeJam\\DeceitfulWar\\D-large.out"));
		pw.print(sol);
		pw.close();
	}
