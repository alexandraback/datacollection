...
int main(){
    freopen("/Users/hao/Dropbox/chmffwn1/gcj/Qualification2014/D/D/D-large-attemp.in", "r", stdin);
    freopen("/Users/hao/Dropbox/chmffwn1/gcj/Qualification2014/D/D/D-large.out", "w", stdout);
