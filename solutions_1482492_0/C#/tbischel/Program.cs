...
namespace ProblemB
{
    class Program
    {
        ...
        {
            const string inputFile = @"E:\Visual Studio Projects\Google Code Jam\cj2012\GoogleCodeJam1C\ProblemB\Input\B-small-attempt0.in";
            const string outputFile = @"E:\Visual Studio Projects\Google Code Jam\cj2012\GoogleCodeJam1C\ProblemB\Output\Small-0.txt";
