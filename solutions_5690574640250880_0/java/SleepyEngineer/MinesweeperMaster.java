...
public class MinesweeperMaster {
	...
	public void doMain() throws Exception {
		Scanner fr = new Scanner(new FileReader("src/minesweeperMaster/C-small-attempt2.in"));
		PrintWriter fw = new PrintWriter(new FileWriter("src/minesweeperMaster/C-small.out"));
