...
public class MinesweeperMaster {
	...
	private void run() throws Exception {
		BufferedReader in = new BufferedReader(new FileReader(
				"minesweeper_small.in"));
		PrintWriter out = new PrintWriter(
				new FileWriter("minesweeper_small.out"));
	...
	// if (r * c - m < 2)
	// return res2;
	// // now print the answer for width = 1
	// if (r == 1) {
	// String temp = "c";
	...
	// if (r * c - m < 4)
	// return res2;
	// // now print the answer for width >= 2
	// char[][] table = new char[r][c];
	// table[0][0] = 'c';
	// table[0][1] = '.';
	// table[1][0] = '.';
	// table[1][1] = '.';
	// int emptySpaceCount = r * c - 4 - m;
