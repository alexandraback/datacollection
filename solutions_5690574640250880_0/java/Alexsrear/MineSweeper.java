...
public class MineSweeper {
	...
	public Point checkBoard(int[][] board) {
		...
		ArrayList<Point> undeal = new ArrayList<Point>();
		int mcount = 0;
		int opencount = 0;
		int r = board.length;
		int c = board[0].length;
	...
	public static void main(String[] args) {
		...
		try {
			...
			*/
			...
			String infilename="d:/codejam/data/C-small-attempt4.in";
			String outfilename="d:/codejam/data/C-small-attempt4.out";
