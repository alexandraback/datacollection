    ...
    class Resolucion
    {
        public static void Resolver(string path)
        {
            ...
            for (int t = 0; t < T; ++t)
            {
                ...
                //double otherCarTimeToFinish = 0;
                //for (int i = 1;  i < N;  i++)
                //{
                //    if (positions[i].X >= D)
                //    {
                //        double otherCarSpeed = (positions[i].X - positions[i - 1].X) / (positions[i].T - positions[i - 1].T);
                //        otherCarTimeToFinish += (D - positions[i - 1].X) / otherCarSpeed;
                //    }
                //    else
                //    {
                //        otherCarTimeToFinish += positions[i].T - positions[i - 1].T;
                //    }
                //}
                ...
                for (int i = 0; i < A; i++)
                {
                    ...
                    //if (a > minA)
                    //{
                    //    timeElapsed = otherCarTimeToFinish;
                    //}
                    //else
                    //{
                        ...
                        for (int p = 1; p < N; p++)
                        {
                            ...
                            if (myCarTime <= otherCarTime)
                            {
                                if (positions[p].X >= D)
                                {
                                    ...
                                    //if (timeElapsed == otherCarTimeToFinish)
                                      //  minA = a;
                                    break;
                                }
